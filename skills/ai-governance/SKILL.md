...
group: Compliance
description: >-
  Design responsible-AI policy, model risk assessment, bias auditing and human-in-the-loop
  controls. Use when designing responsible-AI policies, model risk, or EU AI Act compliance.
---
# AI Governance

Design responsible-AI policy, model risk assessment, bias auditing and human-in-the-loop controls..

> [!IMPORTANT]
> **Licensed-Review Requirement**: This skill provides structured analysis, templates, and issue identification. It does not provide licensed legal counsel, formal legal opinions, or replace attorney review for your specific jurisdiction.
